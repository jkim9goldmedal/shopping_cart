                            ...
                            if kanakaku == '1':
                                ...
                                while zipf < 1:
                                    try:
                                        ...
                                        elif checkzipcode == 7 or checkzipcode == 6:
                                            zipcodestr = zipcodestr.zfill(7)
                                            resultzipcode = zipcodestr
                                            zipkaku = input(zipcodestr + 'で間違いないですか？（1:はい　2:いいえ）>')
                                            if zipkaku == '1':
                                                addressf = 0
                                                while addressf < 1:
                                                            ...
                                                            while telf < 1:
                                                                try:
                                                                    ...
                                                                    if tel == 0:
                                                                        ...
                                                                        resulttel = tel1
                                                                        telkaku = input(tel1 + 'で間違いないですか？（1:はい　2:いいえ）>')
                                                                        if telkaku == '1':
                                                                            # cusrankf = 0
                                                                            # while cusrankf < 1:
                                                                            #     try:
                                                                                                                                ...
                                                                                                                                if password == '0':
                                                                                                                                    ...
                                                                                                                                    if passkaku == '1':
                                                                                                                                        ...
                                                                                                                                        while saisyuf < 1:
                                                                                                                                            ...
                                                                                                                                            if saisyu == '1':
                                                                                                                                                result = resultname,resultkana,resultzipcode,resultaddress,resulttel,resulthaisouryou,resultmail,resultloginid,resultpassword
                                                                                                                                                conn = sql_execute()
                                                                                                                                                cur = conn.cursor(pymysql.cursors.DictCursor)
                                                                                                                                                cur.execute("USE shopping_cart")
                                                                                                                                                conn.commit()
                                                                                                                                                cus = "insert into 顧客(名前,カナ,郵便番号,住所,電話番号,配送料管理番号,メールアドレス,ログインID,ログインパスワード)\
